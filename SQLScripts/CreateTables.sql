...
CREATE TABLE CONSIGNACIONES(
  CON_CODIGO numeric(10,0) NOT NULL,
  CUE_NUMERO Varchar(30) NOT NULL,
...
CREATE TABLE TRANSFERENCIAS(
  TRAN_CODIGO numeric(10,0) NOT NULL,
  ORIGEN_CUE_NUMERO Varchar(30) NOT NULL,
  DESTINO_CUE_NUMERO Varchar(30) NOT NULL,
  USU_CEDULA numeric(10,0),
  TRAN_VALOR numeric(10,2) NOT NULL,
  TRAN_FECHA Timestamp(6) NOT NULL,
  TRAN_DESCRIPCION Varchar(50) NOT NULL
)
;

-- Add keys for table TRANSFERENCIAS

ALTER TABLE TRANSFERENCIAS ADD CONSTRAINT TRAN_CODIGO PRIMARY KEY (TRAN_CODIGO,ORIGEN_CUE_NUMERO,DESTINO_CUE_NUMERO)
;
...
ALTER TABLE TRANSFERENCIAS ADD CONSTRAINT ORIGEN_TRANSFERENCIAS FOREIGN KEY (ORIGEN_CUE_NUMERO) REFERENCES CUENTAS (CUE_NUMERO)
;

ALTER TABLE TRANSFERENCIAS ADD CONSTRAINT DESTINO_TRANSFERENCIAS FOREIGN KEY (DESTINO_CUE_NUMERO) REFERENCES CUENTAS (CUE_NUMERO)
;
